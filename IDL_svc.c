...
nfs_fuse_1000(struct svc_req *rqstp, register SVCXPRT *transp)
{
	...
	case FTRUNCATE:
		_xdr_argument = (xdrproc_t) xdr_ftruncate_IDL;
		_xdr_result = (xdrproc_t) xdr_int;
		local = (char *(*)(char *, struct svc_req *)) ftruncate_1000_svc;
		break;

	case FDATASYNC:
		_xdr_argument = (xdrproc_t) xdr_fdatasync_IDL;
		_xdr_result = (xdrproc_t) xdr_int;
		local = (char *(*)(char *, struct svc_req *)) fdatasync_1000_svc;
		break;

	case FSYNC:
		_xdr_argument = (xdrproc_t) xdr_fsync_IDL;
		_xdr_result = (xdrproc_t) xdr_int;
		local = (char *(*)(char *, struct svc_req *)) fsync_1000_svc;
		break;
